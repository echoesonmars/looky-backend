"""Attention processors from CatVTON (https://github.com/Zheng-Chong/CatVTON)."""
from torch.nn import functional as F
import torch


class SkipAttnProcessor(torch.nn.Module):
    """Replaces cross-attention with identity — CatVTON conditions via latent concat, not text."""
